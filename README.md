...
The fan club checkout currently uses BNB Smart Chain (BEP20) with a fixed test conversion rate of `1 BNB = $600`.
The payment address and QR code are configured in `script.js`.
